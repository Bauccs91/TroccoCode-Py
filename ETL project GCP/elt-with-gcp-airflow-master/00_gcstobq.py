...
with DAG(
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='bkt-hlth-cr',  # Replace with your bucket name
        source_objects=['global_health_data.csv'],  # Path to your file in the bucket
        destination_project_dataset_table='etl-lt-002.gbl_hlth_cr_bq_001.gbl-data-raw',  # Replace with your project, dataset, and table name
        source_format='CSV', 
